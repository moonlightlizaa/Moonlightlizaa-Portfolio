...
type PageDocumentDataSlicesSlice = HeroSectionSlice | RichTextSlice;
...
export interface HeroSectionSliceDefaultPrimary {
	/**
	 * Spline Link field in *HeroSection → Primary*
	 *
	 * - **Field Type**: Embed
	 * - **Placeholder**: *None*
	 * - **API ID Path**: hero_section.primary.spline_link
	 * - **Documentation**: https://prismic.io/docs/field#embed
	 */
	spline_link: prismic.EmbedField;
	...
	/**
	 * Hero Bio field in *HeroSection → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: hero_section.primary.hero_bio
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	hero_bio: prismic.RichTextField;
}
